...
export function createRenderer(canvas) {
  ...
  // Removed addHitBurst (hit particle effect disabled)
  ...
  function pushEffectsFromSim(sim) {
    ...
    while (sim.hits.length) {
      ...
      if (h.type === 'attack') { addAttackLine(h.x1,h.y1,h.x2,h.y2); /* hit burst disabled */ }
      else { /* collision spark effect disabled */ }
    }
